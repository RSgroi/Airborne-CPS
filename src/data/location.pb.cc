...
static void InitDefaultsLocation_location_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::tcas::_Location_default_instance_;
    new (ptr) ::tcas::Location();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::tcas::Location::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<0> scc_info_Location_location_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsLocation_location_2eproto}, {}};

void InitDefaults_location_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_Location_location_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_location_2eproto[1];
constexpr ::google::protobuf::EnumDescriptor const** file_level_enum_descriptors_location_2eproto = nullptr;
constexpr ::google::protobuf::ServiceDescriptor const** file_level_service_descriptors_location_2eproto = nullptr;

const ::google::protobuf::uint32 TableStruct_location_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::tcas::Location, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::tcas::Location, id_),
  PROTOBUF_FIELD_OFFSET(::tcas::Location, lat_),
  PROTOBUF_FIELD_OFFSET(::tcas::Location, lon_),
  PROTOBUF_FIELD_OFFSET(::tcas::Location, alt_),
};
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::tcas::Location)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::tcas::_Location_default_instance_),
};

::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_location_2eproto = {
  {}, AddDescriptors_location_2eproto, "location.proto", schemas,
  file_default_instances, TableStruct_location_2eproto::offsets,
...
const char descriptor_table_protodef_location_2eproto[] =
  "\n\016location.proto\022\004tcas\"=\n\010Location\022\n\n\002id"
  "\030\001 \001(\005\022\013\n\003lat\030\002 \001(\001\022\013\n\003lon\030\003 \001(\001\022\013\n\003alt\030"
  "\004 \001(\001b\006proto3"
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_location_2eproto = {
  false, InitDefaults_location_2eproto, 
  descriptor_table_protodef_location_2eproto,
  "location.proto", &assign_descriptors_table_location_2eproto, 93,
};
...
void AddDescriptors_location_2eproto() {
 ...
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_location_2eproto, deps, 0);
}

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_location_2eproto = []() { AddDescriptors_location_2eproto(); return true; }();
namespace tcas {
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 4: {
        ...
        msg->set_alt(::google::protobuf::io::UnalignedLoad<double>(ptr));
        ptr += sizeof(double);
        break;
      }
      default: {
...
::google::protobuf::Metadata Location::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_location_2eproto);
  return ::file_level_metadata_location_2eproto[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> PROTOBUF_NOINLINE ::tcas::Location* Arena::CreateMaybeMessage< ::tcas::Location >(Arena* arena) {
  return Arena::CreateInternal< ::tcas::Location >(arena);
}
}  // namespace protobuf
}  // namespace google
